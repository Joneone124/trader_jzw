...
def alert(cate, rate):
    ...
    r = requests.post(url='https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=40d02a28-201b-4aeb-a73c-729c0971bdc2',
                      json=data)


    file_image = open('pic_little.jpg', 'rb').read()
    ...
    requests.post('https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=40d02a28-201b-4aeb-a73c-729c0971bdc2', data=json.dumps(data))
    print(r.text)
